...
% --------------------------------------------------------------------------------------------------
        ...
        WoodsUIPanel = uipanel('parent',gcf,'Position',[-8.163265306122449E-4 -8.802816901408451E-4 0.746938775510204 0.6075704225352113],'BackgroundColor',[1,1,1],'HighlightColor',[1,1,1],'BorderType','None','Clipping','On','tag','WoodsPlotUIPanel');
        ...
        buffer_sum = ymax_sum_round*0.3; % +20% buffer gap to leave space for CI legend +++++++++++++++++++++++++++++++
        ...
        ln_wp = 1.5; % Line width of confidence limits 
        ...
        for i=1:length(timepoints)
            if i ~= length(timepoints)
                ...
                CV1_pos = line([seqStart seqEnd],[confidenceInterval_CV1(i+1) confidenceInterval_CV1(i+1)],'Color','black','LineStyle',':','LineWidth',ln_wp); % CV1 pos
                CV1_neg = line([seqStart seqEnd],[-confidenceInterval_CV1(i+1) -confidenceInterval_CV1(i+1)],'Color','black','LineStyle',':','LineWidth',ln_wp); % CV1 neg
                CV2_pos = line([seqStart seqEnd],[confidenceInterval_CV2(i+1) confidenceInterval_CV2(i+1)],'Color','black','LineStyle','--','LineWidth',ln_wp); % CV2 pos
                CV2_neg = line([seqStart seqEnd],[-confidenceInterval_CV2(i+1) -confidenceInterval_CV2(i+1)],'Color','black','LineStyle','--','LineWidth',ln_wp); % CV2 neg
                ...
                CI_leg_1 = legend([CV1_pos, CV2_pos],{CV1_text,CV2_text},'Orientation','Horizontal','location','northeast');
